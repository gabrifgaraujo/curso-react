            ...
            <div className="text-center md:text-left">
              ...
              <div className="flex flex-wrap justify-center md:justify-start gap-4 mb-6">
                <div className="bg-gray-700/50 px-4 py-2 rounded-lg">
                  <span className="block text-xl font-bold text-white">{userData.public_repos}</span>
                  <span className="text-gray-400">Repositórios</span>
                </div>
                <div className="bg-gray-700/50 px-4 py-2 rounded-lg">
                  <span className="block text-xl font-bold text-white">{userData.followers}</span>
                  <span className="text-gray-400">Seguidores</span>
                </div>
                <div className="bg-gray-700/50 px-4 py-2 rounded-lg">
                  <span className="block text-xl font-bold text-white">{userData.following}</span>
